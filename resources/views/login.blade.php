    ...
    <div class="min-h-screen flex items-center justify-center p-4">       
        ...
        <div class="w-full max-w-md bg-white rounded-2xl shadow-xl p-6 sm:p-12 border border-gray-100">
            ...
            <form class="space-y-6" action="{{route('login.authenticate')}}" method="POST"> 
                ...
                <!-- NIC Field -->
                <div class="space-y-2">
                    <label for="nic" class="text-sm font-semibold text-[#1a1a1a]">NIC</label>
                    <div class="relative">
                ...
                <div class="flex items-center">
                    <input 
                        ...
                        name="remember-me" 
                        type="checkbox" 
                        class="h-4 w-4 text-[#0044cc] focus:ring-[#29abe2] border-gray-300 rounded cursor-pointer"
                    >
                    <label for="remember-me" class="ml-2 block text-sm text-[#555555] cursor-pointer select-none">
